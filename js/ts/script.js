...
const ira = new Person('Ира', 18);
console.log(ira);
console.log(ira.sayHello());
//создаю объект наследуемого класса
const dnonis = new Student('Денис', 25, 'B1', 2);
console.log(dnonis);
...
const newDenis = dnonis;
console.log(newDenis);
console.log(newDenis.sayHello());
//Попробуем преобразовать другим способом:
const eve = new Student('Ева', 21, 'C2', 3);
console.log(eve);
console.log(eve.sayHello());
//
const dula = new Teacher('Дулат Мустафиевич', 50, ['Физическая культура', 'Завуч', 'Биология']);
console.log(dula);
